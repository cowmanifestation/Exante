= Exante
A web based tool that helps individuals/groups to organize foss events.

== Installation
	sudo bundle install

== Long term Objective
To  develop a collaboration tool for organizing FOSS events.
...
== Why?
No decent FOSS event planners exist.
